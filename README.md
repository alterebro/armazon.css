...
**armazon**.css will make a lot easier to kick start your responsive web application, in order to have the pre-compiled version of armazon up and running on your site, just follow these simple steps:
...
3. **Done**, that's all. Now, you can start your development, here's a simple **[HTML template](http://codepen.io/alterebro/pen/PqYQMY)** to help you get started.
...
## <a name="the-grid"></a>Understanding The Grid
